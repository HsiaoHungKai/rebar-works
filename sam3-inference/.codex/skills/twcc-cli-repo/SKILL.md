...
5. Handle command drift and unexpected errors explicitly.
   ...
   If the command still fails, capture the exact command, stderr, and relevant context under `.codex/twcc/`.
...
6. Keep transient artifacts repository-local.
   Write captured JSON, command transcripts, generated templates, or working notes under repo-local paths such as `.codex/twcc/`.
...
Keep the skill itself under this repository and avoid assuming the user wants a global `~/.codex/skills` install.
