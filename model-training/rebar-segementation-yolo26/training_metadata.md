...
| --- | --- | --- | --- | --- | --- | ---: | ---: | ---: | --- | ---: | ---: | --- |
| v1 | `scripts/train_rebar_seg_yolo26_v1.sh` | `train.py` | `dataset-v1` | `yolo26l-seg.pt` | `${REMOTE_WORKDIR}/datasets/sam3_annotation_without_open_source_rebar_v1/data.yaml` | 100 | 640 | 4 | `0` | 30 | 0 | `yolo26x_sam3_rebar_v1` |
| v2 | `scripts/train_rebar_seg_yolo26_v2.sh` | `train.py` | `dataset-v1` | `yolo26l-seg.pt` | `${REMOTE_WORKDIR}/datasets/sam3_annotation_without_open_source_rebar_v1/data.yaml` | 126 | 640 | 16 | `0` | 30 | 0 | `yolo26x_sam3_rebar_v2` |
